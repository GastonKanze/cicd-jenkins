...
def repositories = [["https://github.com/Kornil/simple-react-app.git", "simple-react-app", "app1"], ["https://github.com/aditya-sridhar/simple-reactjs-app.git","simple-reactjs-app", "app2"] ]
def indexToDeploy
